...
try {
   ...
   // Connect to the database using PDO with prepared statements
    ...
    foreach ($username_ag as $value) {
        ...
        $temp['mont_gen']=$username_ag['mont_mens'];
        # code...
